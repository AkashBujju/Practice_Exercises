...
// camera
glm::vec3 cameraPos   = glm::vec3(15.451f, 4.855f, 0.257f);
glm::vec3 cameraFront = glm::vec3(-0.420f, -0.335f, -0.843f);
...
int main(void) {
   ...
   glfwSetInputMode(window, GLFW_CURSOR, GLFW_CURSOR_DISABLED);
	...
	Terrain t(shader->program, glm::vec2(0.8f, 0.7f), 1000, 200);
	/* Init Others */
